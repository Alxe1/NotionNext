...
const BLOG = {
  ...
  GREETING_WORDS:
    process.env.NEXT_PUBLIC_GREETING_WORDS || '知识丰富自我，科技改变自我',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Littlely', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '科普与技术创作博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://littlely.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'littlely, Notion, 博客', // 网站关键词 英文逗号隔开
  ...
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/scatter_plot.svg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Littlely站点', // 站点描述，被notion中的页面描述覆盖
